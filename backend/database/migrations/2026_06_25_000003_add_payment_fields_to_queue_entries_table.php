...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('queue_entries', function (Blueprint $table) {
            ...
            $table->string('billing_type')->nullable()->after('cpf_cnpj');
            ...
            $table->text('asaas_bank_slip_url')->nullable()->after('asaas_payment_status');
            $table->text('asaas_invoice_url')->nullable()->after('asaas_bank_slip_url');
